...
export default function Home() {
  ...
  // 2. FORMATAÇÃO DE MOEDA (Garante que o zero apareça como R$ 0,00)
  ...
  // ... (mantenha handleDateChange e addTransaction)

  // 6. FUNÇÃO LIMPAR TUDO (Ajustada para reset total)
  const handleClearAll = async () => {
    Alert.alert("Limpar tudo", "Deseja remover todas as transações e zerar o saldo?", [
      { text: "Cancelar", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            ...
            setTransactions([]); // Ao zerar aqui, o balance vira 0 automaticamente
          } catch (e) {
  ...
  // CÁLCULOS (Reativos ao estado transactions)
